                   ...
                   {props.orders.map(order =>
                       <div key={order.id}>
                           ...
                           <Row>
                               ...
                               <Col><Typography.Text strong>${order.order_items.reduce((acc, orderItem) => new Big(orderItem.price), new Big(0)).toFixed(2)}</Typography.Text></Col>
                           </Row>
                       </div>)}
               </div>
           </Layout>
